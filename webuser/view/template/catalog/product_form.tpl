      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a style="display:none" href="#tab-attribute" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            ...
            <li><a style="display:none" href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
          </ul>
          <div class="tab-content">
              ...
              <div style="display:none" class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="date_available" value="2019-12-18" placeholder="<?php echo $entry_date_available; ?>" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
            ...
            <div class="tab-pane" style="display:none" id="tab-attribute">
            ...
            <div class="tab-pane" style="display:none" id="tab-recurring">
              <div class="table-responsive">
            ...
            <div class="tab-pane" style="display:none" id="tab-design">
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
