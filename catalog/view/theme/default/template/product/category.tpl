   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-12 " style="display: flex;    justify-content: end;" >
            <div class="form-group input-group input-group-sm" style="    max-width: 40%;">
            ...
            <div class="product-thumb" style="">
               <div class="image" style="position: relative;">
                  ...
                  <a class="foo" href="<?php echo $product['href']; ?>">
                     <img style="z-index:99999999" src="<?php echo $product['thumb']; ?>"
                        alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>"
                        class="img-responsive pthumb" />
                     <button class="product-wishlist-btn" type="button" data-toggle="tooltip"
                     ...
                     <button type="button"
                        ...
                        class="product-hover"><a href="">ADD TO BAG</a></button>
               ...
               <div>
                  ...
                  <div class="caption" style="text-align:left;">
                     <h3 style="text-transform:uppercase; font-size:16px; margin-top:-25px">
