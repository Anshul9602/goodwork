...
<div style="width: 100%; padding-top:80px; min-height:80vh; margin-bottom:120px" class="container">
  ...
  <div class="row">
    <div style="margin-top:30px; " id="content" class="col-sm-10 col-sm-offset-1 col-xs-12">
      <?php echo $content_top; ?>

      <div class="row">
        <div class="col-sm-12">
          <form style="margin-top: 20px" id="cf" action="<?php echo $action; ?>" method="post"
              ...
              <table class="table table-stripped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <div style="width:120px; margin:auto; margin-top:20px; " class="row">
                        <div
                          ...
                          class="col-sm-4">
                          <li style=" font-size:12px; margin:auto; text-align:center;"
                            class="fa fa-minus less_quantity"></li>
                        </div>
                        <div style=" padding-left:0px; padding-right:0px;" class="col-sm-4"><input
                            style="box-shadow:none; height:34px; text-align:center; border-radius:0px; width:100%; cursor:default"
                            class="input-quantity" readonly name="quantity[<?php echo $product['cart_id']; ?>]"
                        ...
                        <div
                          ...
                          class="col-sm-4">
                          <li style="font-size:12px; text-align:center;" class="fa fa-plus add_quantity"></li>
                        </div>
                      </div>
                    ...
                    <td style="text-align:center; padding-right:30px"><button
                        style="background-color: transparent; outline:none; margin:auto; margin-top:15px; text-align:center; margin-left:10px; border:none; box-shadow:none "
                        type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn"
          ...
          <form style="margin-top: 20px" id="cf1" action="<?php echo $action; ?>" method="post"
            enctype="multipart/form-data">
            ...
            <div class="row" id="mobile_table">
              <div class="col-xs-12">
                ...
                <div class="row">
                  ...
                  <div style="margin-left:-20px" class="col-xs-8">
                    ...
                    <p style="margin-left: -10px;margin-top: -15px;">
                      <button
                        style="background-color: transparent; outline:none; margin:auto;  text-align:center; border:none; box-shadow:none "
                        type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn"
                        onclick="cart.remove('<?php echo $product['cart_id']; ?>');">
                        Remove
                      </button>
                ...
                <div class="row">
                  <div class="col-xs-7">
                    <div style="width:120px; margin:auto; margin-top:20px; margin-left:0px " class="row">
                      ...
                      <div style=" padding-left:0px; padding-right:0px;" class="col-xs-4">
                        <input
                          style="box-shadow:none; height:34px; text-align:center; border-radius:0px; width:100%; cursor:default"
                          class="input-quantity1" readonly name="quantity[<?php echo $product['cart_id']; ?>]"
                          value="<?php echo $product['quantity']; ?>" class="form-control" />
                      </div>
                      <div
                        style=" cursor: pointer; padding-left:0px; padding-right:0px; height:34px; text-align:center; border:thin solid #ccc"
                  ...
                  <div class="col-xs-5">
                    <h4 style="margin-top: 30px; font-size:12px">Total :
                      <?php echo $product['total']; ?>
                    </h4>
                ...
                <div class="col-sm-12">
                  ...
                  <div class="buttons clearfix">
                    <div class="pull-right">
                      <a style="margin-bottom:30px" href="index.php?route=account/login"> <button
                          class="btn btn-empty" style="    padding: 15px 30px 15px 30px;color:#000;">Login</button></a>&nbsp;&nbsp;
                      <a id="gck" href="index.php?route=checkout/guest_new"> <button class="btn btn-primary">Guest
                          Checkout</button></a>
                    </div>
                  </div>
                  <?php }else{?>
                  <div class="buttons clearfix">
                    <div class="pull-right">
                      <a href="index.php?route=checkout/registered_payment"> <button
