...
<form class="form-horizontal">
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
   ...
   <div class="row">
    ...
    <label  style="display:none" class="col-sm-2 control-label" for="input-shipping-company"><?php echo $entry_company; ?></label>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" disabled value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
    </div>
  </div>
</form>
