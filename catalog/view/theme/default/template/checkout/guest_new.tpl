...
<div id="status_check" style="margin-top:-30px" class="row">
 ...
 <div class="row">
  <div class="col-sm-12">
    <h3 style="text-align:center; margin-top: 60px; margin-bottom:40px">BILLING ADDRESS</h3>
        <hr />
  </div>
 </div>
 <div class="row">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="row">
       ...
       <div style="padding-right:0px" id="pin_box" class="col-sm-4">
        <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="PIN/ZIP code" id="input-payment-postcode" class="form-control" />
       </div>
      </div>
      </div>
