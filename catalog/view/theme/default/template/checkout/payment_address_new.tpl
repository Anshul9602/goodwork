...
.address_card{ padding:10px; }
.card_body{border:thin solid #f1f1f1; min-height:148px; box-shadow:1px 1px 1px #f1f1f1; padding:10px; cursor:pointer; transition-duration:100ms; -webkit-transition-duration:100ms}
.card_body:hover{-webkit-transform:scale(1.03); box-shadow:2px 2px 2px #f1f1f1; transition-duration:100ms; -webkit-transition-duration:100ms}
.card_body .fa-check-circle{color:green; position:absolute; top:20px; right:20px; display:none; list-style:none}
  ...
  <div id="payment-existing">
   <div class="row">
     ...
     <input type="hidden" class="address_id" value="<?php echo $address['address_id']; ?>" />
       <h4 style="text-transform:capitalize"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?></h4>
       <p><?php echo $address['address_1']; ?>,<br /> <?php echo $address['city']; ?>,<?php echo $address['postcode']; ?>,<br /> <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></p>
       </div>
     </div>
     <?php }?>
          <?php }?>
  ...
  <div class="col-sm-6">
   <div class="row">
    ...
    <div class="form-group required">
      <label class="control-label" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
        <input type="text" name="firstname" value="" placeholder="" id="input-payment-firstname" class="form-control" />
    </div>
    </div>
   </div>
   ...
   <div class="row">
    ...
    <div class="form-group required">
      ...
      <input type="text" name="lastname" value="" placeholder="" id="input-payment-lastname" class="form-control" />
    </div>
    </div>
   </div> 
   ...
   <div class="row">
    <div class="col-sm-8">
      ...
      <label class="control-label" for="input-payment-city"><?php echo $entry_city; ?></label>
        <input type="text" name="city" value="" placeholder="" id="input-payment-city" class="form-control" />
     </div>
    </div>
    
    <div style="padding-right:0px" class="col-sm-4">
       <label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
       <input type="text" name="postcode" value="" placeholder="" id="input-payment-postcode" class="form-control" />    </div>
   </div> 
