...
<section style="display:none;">
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-3 col-md-6 col-sm-6 footer-tab">
            <img src="catalog/view/theme/default/image/goodwork_home/fast-delivery.png" alt="" class="img-responsive">
            <h6>FAST & FREE DELIVERY</h6>
         </div>
         <div class="col-lg-3 col-md-6 col-sm-6 footer-tab">
            <img src="catalog/view/theme/default/image/goodwork_home/days-free.png" alt="" class="img-responsive">
            <h6>RECYLCABLE & ECO-FREINDLY </h6>
         </div>
         <div class="col-lg-3 col-md-6 col-sm-6 footer-tab">
            <img src="catalog/view/theme/default/image/goodwork_home/cod.png" alt="" class="img-responsive">
            <h6>SECURE PAYMENTS</h6>
         </div>
         <div class="col-lg-3 col-md-6 col-sm-6 footer-tab">
            <img src="catalog/view/theme/default/image/goodwork_home/online-support.png" alt="" class="img-responsive">
...
<script>
   $(document).ready(function () {
      $("#search_opener").click(function () {
         ...
         $("#overlay_mob1").fadeToggle();
         $(".search_opened").slideToggle();
   ...
   $(document).ready(function (e) {
      $("#join_us").click(function () {
         if (isEmail($("#mail_boxj").val())) {
            $.ajax({
               type: 'POST',
               url: 'index.php?route=common/footer/add_subscrib',
               data: {
                  email: $("#mail_boxj").val()
               },
            ...
            $("#mail_boxj").css('border', 'thin solid red');
         }
