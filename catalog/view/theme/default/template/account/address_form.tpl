...
<h1 class="big">ACCOUNT INFO</h1>
<h2 style="letter-spacing:6px" class="mb-4">ACCOUNT INFO</h2>
</div>
</div>
  ...
  <div class="row">
   <div class="col-sm-10 col-sm-offset-1">
      ...
      <p style="text-align:center; letter-spacing:2px">Edit personal information</p><br />
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
		 ...
		 <div class="col-sm-6">
            ...
            <div class="col-sm-6">
            	<input type="text" name="telephone" value="<?php echo $telephone; ?>" placeholder="Phone Number" id="input-telephone" class="form-control" />
         ...
         <div class="form-group required">
              ...
              <textarea name="address_1" rows="3" id="input-address-1" class="form-control"><?php $a=$address_1; echo trim($a);?>
               </textarea>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-6">
              <select name="country_id" value="99" id="input-country" class="form-control">
          ...
          <div style="display:none" class="form-group required">
            <div style="padding:0px" class="col-sm-12">
             <div style="padding-right:0px" class="col-sm-3">
                   <input type="text" onkeypress="return isNumber(event)" value="" name="bday_day" placeholder="DD" id="input-day" class="form-control" />
              </div>
              <div style="padding-right:0px" class="col-sm-3">
               <input type="text" value="" onkeypress="return isNumber(event)" name="bday_month" placeholder="MM" id="input-day" class="form-control" />
              </div>
              <div class="col-sm-6">
            <input type="text" name="bday_year" value="" onkeypress="return isNumber(event)" placeholder="YYYY" id="input-day" class="form-control" />
              </div>
            </div>
          </div>
          ...
          <div style="display:none" class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        ...
        <div style="text-align:center" class="buttons clearfix">
          <div>
            <input type="submit" value="SAVE CHANGES" class="btn btn-primary" /><br />
            <a style="font-family:Josefin Sans; color:#333" href="index.php?route=account/password">Change Password</a>
          </div>
        </div>
      </form>
...
$(document).ready(function(e) {
   $.ajax({
		url: 'index.php?route=account/account/country&country_id=99',
		dataType: 'json',
		beforeSend: function() {
