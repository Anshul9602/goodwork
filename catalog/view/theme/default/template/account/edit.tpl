...
<div style=" width: 100%" class="container">
 ...
 <div class="col-sm-12" style="background-color:#F2F2F2; padding-top:30px; padding-bottom: 30px;">
    ...
    <div style="text-align: center" class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
      
    
    <h2 style="font-family: play">Account Info</h2>
	 </div>
   </div>
  </div>
  <br /><br />
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-6">
              <input type="tel" style="background:none" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" />
        ...
        <div style="margin-top:30px" class="buttons clearfix">
